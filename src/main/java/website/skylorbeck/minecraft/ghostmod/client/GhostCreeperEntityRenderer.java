...
public class GhostCreeperEntityRenderer extends MobEntityRenderer<CreeperEntity, CreeperEntityModel<CreeperEntity>> {
    private static final Identifier TEXTURE = new Identifier("ghostmod:textures/entity/creeper/creeper.png");

    public GhostCreeperEntityRenderer(EntityRendererFactory.Context context) {
